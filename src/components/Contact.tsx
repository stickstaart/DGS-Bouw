  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      val: "info@dgsbouw.nl",
      href: "mailto:info@dgsbouw.nl"
    },
    {
      icon: MapPin,
      label: "Locatie",
      val: "Rooije-Hoefsedijk 68, Gemert",
      href: "https://www.google.com/maps/search/?api=1&query=Rooije-Hoefsedijk+68+Gemert"
    }
  ];
            ...
            <div className="space-y-6 w-full">
              {contactInfo.map((item, idx) => (
                <a
                  ...
                  className="flex flex-col items-center lg:flex-row lg:items-start space-y-3 lg:space-y-0 lg:space-x-4 group cursor-pointer"
                >
